...
//    var color = prompt('type a traffic light color into the prompt')
//     if(color === 'red') {
//         alert('When the light is red you should stop!')
...
//     } else {
//         alert('if the light color is anything else there is a problem!')
//     }
// }
//
// console.log(light());
