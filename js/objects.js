...
shoppers.forEach(function(x) {
    var discount = 0
    if (x.amount >= 200) {
        discount = x.amount * .12;
      var total = x.amount - discount
    console.log(x.name + " bill was was $" + x.amount + ". They received a discount of " + discount + " and their total was " + total)
    } else {
        console.log(x.name + " you do not get a discount")
    }
})
